...
public class MovementUtils {
	...
	public static void setRaycastedPositionOffsetted(double offset) {
    	...
    	mc.thePlayer.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(mc.thePlayer.posX + -MathHelper.sin(getDirection()) * offset, mc.thePlayer.boundingBox.minY, mc.thePlayer.posY, mc.thePlayer.posZ + MathHelper.cos(getDirection()) * offset, mc.thePlayer.onGround));
    }
