...
public class SettingsManager {
	...
	public Setting getSettingByName(String name){
		...
		System.err.println("["+ Atlas.instance.name + "] Error Setting NOT found: '" + name +"'!");
		return null;
	}
	...
	public Setting getSettingByNameAndMod(String name, Module mod){
		...
		System.err.println("["+ Atlas.instance.name + "] Error Setting NOT found: '" + name +"' for mod " + mod.getName() + "!");
		return null;
	}
