...
import me.xtrm.Atlas.guis.xray.GuiBlacklist;
import me.xtrm.Atlas.utils.GuiUtils;
import me.xtrm.Atlas.utils.Wrapper;

public class XRayConfigElement extends BasicElement {

	public XRayConfigElement(ModuleButton parent) {
		super(null, parent);
	}
	...
	public boolean mouseClicked(int mouseX, int mouseY, int mouseButton) {
		...
		if(this.isHovered(mouseX, mouseY) && !this.isHoveredUp(mouseX, mouseY)) {
			if(mouseButton == 0) {
				Wrapper.mc.displayGuiScreen(new GuiBlacklist(null));
			}
		}
