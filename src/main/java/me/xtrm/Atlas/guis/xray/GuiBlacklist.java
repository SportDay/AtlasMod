package me.xtrm.Atlas.guis.xray;
...
public class GuiBlacklist extends GuiScreen {
	...
	private final ResourceLocation rl = new ResourceLocation("atlas", "someCoolGUI.png");
	...
	public void drawScreen(int mx, int my, float delta) {
		...
		this.drawCenteredString(fontRendererObj, "X-Ray Config", width / 2, guiTop + 6, 0xFFFFFF);
